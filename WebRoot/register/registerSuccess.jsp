...
<div id="container">
  ...
  <div id="main_box">
    <div id="main">
	 ...
	 <ul>
	 <li class="back_tit">注册成功</li>
	 <li class="send_tip">注册成功！请在24小时之内<a href="<%="http://email."+request.getParameter("email") %>" target="_blank">登录邮箱</a>激活帐号。</li>
	 </ul>
      </div>
    </div>
  </div>
