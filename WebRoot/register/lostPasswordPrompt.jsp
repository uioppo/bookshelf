...
<div id="container">
  ...
  <div id="main_box">
    <div id="main">
	 ...
	 <ul>
	 <li class="back_tit">密码找回邮件发送成功</li>
	 <li class="send_tip">密码找回邮件发送成功，请您注意查收您的邮件！立即<a href="<%="http://email."+request.getParameter("email") %>" target="_blank">登录邮箱</a>。<br><a href="../login.jsp">返回</a></li>
	 </ul>
