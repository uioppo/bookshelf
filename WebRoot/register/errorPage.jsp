...
<div id="container">
  ...
  <div id="main_box">
    <div id="main">
	 ...
	 <ul>
	 <li class="back_tit">系统提示</li>
	 <li class="send_tip" style="background-image:url('../images/sorry.png');">很遗憾，系统没能及时转弯撞树上了！<a href="<%=path%>/index.html">返回首页</a></li>
