...
//				        	 return str;
							 return "<a href='javascript:void(0);' class='easyui-linkbutton l-btn l-btn-plain' onclick='delBook("+row.id+")'><span class='l-btn-left'><span class='l-btn-text icon-search' style='padding-left: 20px; '>删除</span></span><a/>";
				        }},
