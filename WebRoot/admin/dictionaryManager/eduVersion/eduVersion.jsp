...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path %>/admin/dictionaryManager/eduVersion/eduVersion.js"></script>
  ...
  <body style="margin: 0px; padding: 0px; background: #fff;">
  	<div id="top">
  			<a href="javascript:void(0);" onclick="open1()" modal="true" class="easyui-linkbutton" iconCls="icon-add" plain="true">增加教材版本</a>
  		</div>
    <table id="eduVersionList"></table>
