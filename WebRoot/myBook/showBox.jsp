	...
	<script src="<%=path %>/js/more.js" type="text/javascript"></script>
  	...
  	<script type="text/javascript">
  		function addMyBooksByKey(){
  			...
  			if(key!=null&&key!=""){
  				$.ajax({
  					url:path+"/mybook/addMyBookByKey.action",
  					data:"licenseKey="+key+"&math="+Math.random(),
...
<body style="background:none; padding: 0px; margin: 0px;">
  <div id="code_top">
    ...
    <p class="code_top02">授权码<input id="close" style="borde:none;width:18px;height:18px;" name="close" type="image" src="<%=path %>/images/close.gif" onclick="parent.keyboxclose()" /></p>
  ...
  <div id="code_con" style="height: 203px;">
    <ul>
      ...
      <li class="account_input" >
        ...
        <span>
        <input id="sub_button" onclick="addMyBooksByKey()" name="code_button" type="image" src="<%=path %>/images/conde_submit.gif" />
        </span>
        <span id="msg"></span>
        </li>
