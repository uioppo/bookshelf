...
$(function(){
	...
	var type_0 = "<%=type_!=null?type_:""%>";
	var str='当前位置：&nbsp;<%=type_!=null?(type_.equals("1")?"<a href=\"ebooks.action?xd=&xk=&page=0&order=time&sort=1&type=1&gao=ren\" >数字教材</a>":"<a href=\"ebooks.action?xd=&xk=&page=0&order=time&sort=1&type=0&gao=ren\" >数字教辅</a>"):"<a href=\"ebooks.action?xd=&xk=&page=0&order=time&sort=1&gao=ren\" >全部商品</a>"%>';
	var xd='<%=request.getParameter("xd")%>';
	var xk='<%=request.getParameter("xk")%>';
	if(xd!=null&&xd!=""&&xd!="null"){
		if(xd==1||xd=="1"){
			str+="&nbsp;&gt;&nbsp;<a href=\"ebooks.action?xd=1&xk=&page=0&order=time&sort=1&type="+type_0+"&gao=ren\" >小学</a>";
		}else if(xd==2||xd=="2"){
			str+="&nbsp;&gt;&nbsp;<a href=\"ebooks.action?xd=2&xk=&page=0&order=time&sort=1&type="+type_0+"&gao=ren\" >初中</a>";
		}else if(xd==3||xd=="3"){
			str+="&nbsp;&gt;&nbsp;<a href=\"ebooks.action?xd=3&xk=&page=0&order=time&sort=1&type="+type_0+"&gao=ren\" >高中</a>";
		}
	}
	if(xk!=null&&xk!=""&&xk!="null"){
		str+="&nbsp;&gt;&nbsp;"+xk;
	}
	$("#alreadySerch").html(str);
})
...
<style type="text/css">
	.pagination{float: right; margin-top: 2px;}
		...
		#alreadySerch a{color: #1A66B3;text-decoration: none;}
...
<div id="container">
  ...
  <div id="main_box">
    <div id="main">
      <div id="main_con">
        <div id="main_menu">
          <div id="menu_tit"><img src="images/menu_list01.gif" /><img src="images/menu_tit.gif" /></div>
          <div id="menu_con" style="height: 550px;">
            <ul id="menu_list">
              <li><a  id="menu_current"  href="ebooks.action?xd=&xk=&page=0&order=time&sort=1&type=1&gao=ren" >数字教材</a>
                <ul id="ChildMenu01" class="expanded" >
                  <li>
                    <div class="s_menu">
                      <ul>
                        <li class="grade" onclick="ebookByType(1,1);return false;" style="cursor: pointer;">【小学】</li>
                        <li id="t1s1"><a href="ebooks.action?xd=1&xk=%E8%AF%AD%E6%96%87&page=0&order=time&sort=1&type=1&gao=ren">语文</a></li>
                        <li id="t1s2"><a href="ebooks.action?xd=1&xk=%E6%95%B0%E5%AD%A6&page=0&order=time&sort=1&type=1&gao=ren">数学</a></li>
                        <li id="t1s3"><a href="ebooks.action?xd=1&xk=%E8%8B%B1%E8%AF%AD&page=0&order=time&sort=1&type=1&gao=ren">英语</a></li>
                      </ul>        
                      <ul>         
                        <li class="grade" onclick="ebookByType(1,2);return false;" style="cursor: pointer;">【初中】</li>
                        <li id="t1c1"><a href="ebooks.action?xd=2&xk=%E8%AF%AD%E6%96%87&page=0&order=time&sort=1&type=1&gao=ren">语文</a></li>
                        <li id="t1c2"><a href="ebooks.action?xd=2&xk=%E6%95%B0%E5%AD%A6&page=0&order=time&sort=1&type=1&gao=ren">数学</a></li>
                        <li id="t1c3"><a href="ebooks.action?xd=2&xk=%E8%8B%B1%E8%AF%AD&page=0&order=time&sort=1&type=1&gao=ren">英语</a></li>
                        <li id="t1c4"><a href="ebooks.action?xd=2&xk=%E7%89%A9%E7%90%86&page=0&order=time&sort=1&type=1&gao=ren">物理</a></li>
                        <li id="t1c5"><a href="ebooks.action?xd=2&xk=%E5%8C%96%E5%AD%A6&page=0&order=time&sort=1&type=1&gao=ren">化学</a></li>
                        <li id="t1c6"><a href="ebooks.action?xd=2&xk=%E7%94%9F%E7%89%A9&page=0&order=time&sort=1&type=1&gao=ren">生物</a></li>
                      </ul>
                    </div>
                  </li>
                </ul>
              </li>
              <li><a href="ebooks.action?xd=&xk=&page=0&order=time&sort=1&type=0&gao=ren">数字教辅</a>
                <ul id="ChildMenu02" class="expanded">
                  <li>
                    <div class="s_menu">
                      <ul>
                        <li class="grade" onclick="ebookByType(0,1);return false;" style="cursor: pointer;">【小学】</li>
                        <li id="t0s1"><a href="ebooks.action?xd=1&xk=%E8%AF%AD%E6%96%87&page=0&order=time&sort=1&type=0&gao=ren">语文指导书</a></li>
                        <li id="t0s2"><a href="ebooks.action?xd=1&xk=%E6%95%B0%E5%AD%A6&page=0&order=time&sort=1&type=0&gao=ren">数学指导书</a></li>
                      </ul>
                      <ul>
                        <li class="grade" onclick="ebookByType(0,2);return false;" style="cursor: pointer;">【初中】</li>
                        <li id="t0c1"><a href="ebooks.action?xd=2&xk=%E8%AF%AD%E6%96%87&page=0&order=time&sort=1&type=0&gao=ren">语文指导书</a></li>
                        <li id="t0c2"><a href="ebooks.action?xd=2&xk=%E6%95%B0%E5%AD%A6&page=0&order=time&sort=1&type=0&gao=ren">数学指导书</a></li>
                      </ul>
                    </div>
                  </li>
                </ul>
...
<!--             <script src="js/main_menu.js" type="text/javascript"></script> -->
	...
	<div class="sort_search">排序：<input name="price_sort" type="image" by='1' id="price_sort" src="images/price_sort.gif" width="48" height="26" />
	<input name="time_sort" id="time_sort" by='0' type="image" src="images/time_sort.gif" width="72" height="26" />
	<span id="alreadySerch" style="float: right;line-height: 26px;height: 26px; margin-top:0px;*margin-top:-26px;_margin-top:-26px; padding-right: 15px;"></span>
	</div>
	...
	<li class="in_product_cart">
		<input name="product_cart" type="image" onclick="tocart(<s:property value='productId'/>)" src="images/prdouct_cart.gif" width="79" height="21" />
